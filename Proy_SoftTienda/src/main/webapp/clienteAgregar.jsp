		...
		var agregar = $.ajax({
			...
			url: "http://localhost:8080/registrarCliente?cedulaCliente="+cedula+
				...
				success: function(data){
					window.location.assign("http://localhost:8080/clientes.jsp");
		}
		});
	}
...
<body>
	...
	<div class="container mt-8 col-lg-4">
		<div class="card col-sm-15">
			<div class="card-body">
				<form action="" method="get" onsubmit="agregarCliente()">
			
				<div class="mb-3 row" class="form-group text-center">
				<label for="cedulaCliente" class="col-sm-3 col-form-label">Cédula</label>
				<div class="col-sm-8">
					<input type="number" class="form-control" name="cedulaCliente" id="cedula">
				</div>
				</div>

				
				<div class="mb-3 row" class="form-group text-center">
					<label for="direccionCliente" class="col-sm-3 col-form-label">Dirección</label>
					<div class="col-sm-8">
					...
					<div class="mb-3 row" class="form-group text-center">
						<label for="emailCliente" class="col-sm-3 col-form-label">Email</label>
						<div class="col-sm-8">
						...
						<div class="mb-3 row" class="form-group text-center">
							<label for="nombreCliente" class="col-sm-3 col-form-label">Nombre</label>
							<div class="col-sm-8">
							...
							<div class="mb-3 row" class="form-group text-center">
								<label for="telefonoCliente" class="col-sm-3 col-form-label">Teléfono</label>
								<div class="col-sm-8">
